CREATE TABLE [dbo].[schtimes_tl_waitqueue] (
    [id]              BIGINT        IDENTITY (100437, 1) NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [activated]
    ON [dbo].[schtimes_tl_waitqueue]([activated] ASC, [dateactivate] ASC);


GO
ALTER INDEX [activated]
    ON [dbo].[schtimes_tl_waitqueue] DISABLE;
