...
CREATE PROCEDURE [dbo].[uspWSOL_SSRS_SCHEDULE_BY_INTERVAL_WITH_DATE_SCHEDULED]
 @DATE_BEG				DATETIME
,@DATE_END				DATETIME
,@DATE_INS				DATETIME
...
--  EXECUTE [dbo].[uspWSOL_SSRS_SCHEDULE_BY_INTERVAL_WITH_DATE_SCHEDULED] '08/31/2017','08/31/2017','08/25/2017','0','0','106','ALL','H','H','','MAN','DLY'
...
--==================================================================================
IF OBJECT_ID('TEMPDB..#WSOL_FUNCTION_SCHEDULE_DETAILS_WITH_DATE_SCHEDULED') IS NOT NULL BEGIN
   DROP TABLE #WSOL_FUNCTION_SCHEDULE_DETAILS_WITH_DATE_SCHEDULED
END
CREATE TABLE #WSOL_FUNCTION_SCHEDULE_DETAILS_WITH_DATE_SCHEDULED
...
INSERT INTO #WSOL_FUNCTION_SCHEDULE_DETAILS_WITH_DATE_SCHEDULED
(
  AGENT_FIRST_NAME
 ,AGENT_MIDDLE_NAME
 ,AGENT_LAST_NAME
...
FROM
 TVF_WSOL_SCHEDULE_DATA_BY_INTERVALS_WITH_DATE_SCHEDULED(@DTM_BEG, @DTM_END, @DTM_INS, @INTERVAL, @DUR_IN, @CLIENT_ID, @PROGRAM_ID) RESULT
GROUP BY
 RESULT.AGENT_FIRST_NAME
,RESULT.AGENT_MIDDLE_NAME
,RESULT.AGENT_LAST_NAME
...
(	
	SELECT
	 ISNULL(SCH.RESOURCE_NAME		,INV.RESOURCE_NAME)		AS RESOURCE_NAME
...
GROUP BY
 ISNULL(SCH.RESOURCE_NAME		,INV.RESOURCE_NAME)
...
IF @SUPPRESS_ZEROS = 1
	...
	BEGIN
		...
		,V.*
		FROM	#WSOL_FUNCTION_SCHEDULE_DETAILS_WITH_DATE_SCHEDULED		V
