...
GO
PRINT N'Starting rebuilding table [dbo].[david]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_david] (
    [Id]        INT          IDENTITY (1, 1) NOT NULL,
    [davidname] VARCHAR (50) NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[david])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_david] ON;
        INSERT INTO [dbo].[tmp_ms_xx_david] ([Id], [davidname])
        SELECT   [Id],
                 [davidname]
        FROM     [dbo].[david]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_david] OFF;
    END

DROP TABLE [dbo].[david];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_david]', N'david';
