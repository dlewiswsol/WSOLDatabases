CREATE TABLE [dbo].[schtimes_tl_reduce] (
    ...
    [typeOfRecuce]    VARCHAR (6)   DEFAULT (N'Client') NOT NULL
);


GO
CREATE NONCLUSTERED INDEX [nci_wi_schtimes_tl_reduce_A4A53A25EA0C6FDFE6FB3EEE33BF816A]
    ON [dbo].[schtimes_tl_reduce]([datesch] ASC, [typeOfRecuce] ASC, [idprogr] ASC)
...
CREATE NONCLUSTERED INDEX [idprogr]
    ON [dbo].[schtimes_tl_reduce]([idprogr] ASC, [datesch] ASC);


GO
ALTER INDEX [idprogr]
    ON [dbo].[schtimes_tl_reduce] DISABLE;


GO
CREATE NONCLUSTERED INDEX [id]
    ON [dbo].[schtimes_tl_reduce]([id] ASC);
...
CREATE NONCLUSTERED INDEX [datesch]
    ON [dbo].[schtimes_tl_reduce]([datesch] ASC, [idprogr] ASC);
